...
export default function Hero() {
  const words = [
    ...
    "Experienced with React, Express & MySQL",
...
const profile = {
    name: 'Ismail Husun',
    title: 'Full-Stack Developer | Web Enthusiast | Problem Solver',
    skills: [
        'React', 'Next.js', 'Express', 'MySQL',
        'Prisma', 'Node.js', 'JavaScript', 'TypeScript',
        'Tailwind CSS', 'Multer', 'REST API', 'Git', 'Bootstrap',
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Full-Stack Developer | Penggemar JavaScript | Developer React
                  Bersemangat dalam membangun aplikasi web 🚀 | Merancang sistem
                  yang dapat dikembangkan & terus belajar setiap hari 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/IsmailHusun19"
