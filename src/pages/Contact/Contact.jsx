...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "a7980904-5b7e-4a98-adc1-b7f2348e3d02"); // Replace with your Web3Forms access key
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                ...
                Punya pertanyaan atau ingin bekerja sama? Silakan tinggalkan pesan!
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">ismailhusun2002@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Serang, Banten</p>
                  </div>
                </div>
              </div>
            </div>
